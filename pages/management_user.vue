<template>
  <div class="management">
    ...
    <p @click="logout" class="menu-list" v-if="$auth.loggedIn">Logout</p>
    <NuxtLink to="/management_login" class="btn menu-list">Login</NuxtLink>
    <div class="user-add">
  ...
  methods: {
    ...
    async userDelete(id) {
      ...
      await this.$axios.put(
        "http://127.0.0.1:8000/api/v1/muser/" + id,
        sendData
      );
      this.getContent();
    },
