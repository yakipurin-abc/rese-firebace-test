  ...
  methods:{
    ...
    async send(){
      ...
      if(this.checks.length == 0){
        ...
        await axios.post("/api/evaluation", sendData);
        this.getEvaluation();
    ...
    async getEvaluation(){
      ...
      const evaluation = await axios.get("/api/evaluation/" + this.paramsId)
    ...
    async checkComment() {
      const resData = await axios.get("/api/evaluation/" + this.paramsId + '/' + this.user_id);
