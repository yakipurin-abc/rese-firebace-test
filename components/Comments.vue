  ...
  methods:{
    ...
    async send(){
      ...
      if(this.checks.length == 0){
        ...
        await axios.post("https://creepy-witch-87015.herokuapp.com/api/v1/evaluation/", sendData);
        this.getEvaluation();
        this.$router.push('/')
        } catch{
          alert('正しく入力してください')
    ...
    async getEvaluation(){
      ...
      const evaluation = await axios.get("https://creepy-witch-87015.herokuapp.com/api/v1/evaluation/" + this.paramsId)
    ...
    async deleteComment(id) {
      await this.$axios.delete("https://creepy-witch-87015.herokuapp.com/api/v1/evaluation/" + id);
      this.getEvaluation();
    },
    certification(){
    ...
    //個人の予約データをここで取得
    async getReserve() {
      const resData = await axios.get("https://creepy-witch-87015.herokuapp.com/api/v1/reserve/" + this.paramsId + '/' + this.user_id );
    ...
    async checkComment() {
      const resData = await axios.get("https://creepy-witch-87015.herokuapp.com/api/v1/evaluation/" + this.paramsId + '/' + this.user_id);
